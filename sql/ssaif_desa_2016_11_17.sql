...
--
-- Servidor: localhost
-- Tiempo de generación: 17-11-2016 a las 14:10:43
...
CREATE TABLE IF NOT EXISTS `dbjugadoresdocumentacion` (
  ...
  `refdocumentacion` int(11) NOT NULL,
  ...
  KEY `fk_jugadoresdocu_documentacion_idx` (`refdocumentacion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1 ;
...
ALTER TABLE `dbjugadoresdocumentacion`
  ...
  ADD CONSTRAINT `fk_jugadoresdocu_documentacion` FOREIGN KEY (`refdocumentacion`) REFERENCES `tbdocumentaciones` (`iddocumentacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;
