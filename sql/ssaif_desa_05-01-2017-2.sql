...
--
-- Servidor: localhost
-- Tiempo de generación: 05-01-2017 a las 23:38:18
...
INSERT INTO `dbdefinicionescategoriastemporadas` (`iddefinicioncategoriatemporada`, `refcategorias`, `reftemporadas`, `cantmaxjugadores`, `cantminjugadores`, `dias`, `hora`, `minutospartido`, `cantidadcambiosporpartido`, `conreingreso`, `observaciones`) VALUES
(1, 1, 1, 50, 1, 'Sa', '1530', 80, 99, b'0', ''),
(2, 2, 1, 50, 1, 'Sa', '1600', 80, 99, b'1', '');
...
(2, 4, 'Alpes Suizos', 1, 2, 4, '2017-01-05', '0000-00-00', b'1');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=141 ;
...
(1, 'Clausura', 1, 1, 1, 1, 1, 1, b'1', b'1', b'1', b'1', b'1', '', b'1');
...
INSERT INTO `tbestadospartidos` (`idestadopartido`, `descripcion`, `defautomatica`, `goleslocalauto`, `goleslocalborra`, `golesvisitanteauto`, `golesvisitanteborra`, `puntoslocal`, `puntosvisitante`, `finalizado`, `ocultardetallepublico`, `visibleparaarbitros`) VALUES
(1, 'Gana Local', b'0', 0, b'0', 0, b'0', 3, 0, b'1', b'0', b'0');
...
(1, 'Amonestación', 0, 99, 'A', b'0', b'1', b'0', b'0', b'0');
...
INSERT INTO `tbvaloreshabilitacionestransitorias` (`idvalorhabilitaciontransitoria`, `refdocumentaciones`, `descripcion`, `habilita`, `default`) VALUES
(5, 5, 'H - Si titulo, Si Dominio', b'1', b'1'),
(6, 5, 'I - No Titulo, No Dominio', b'0', b'0'),
(7, 5, 'I - Si Titulo, No Dominio', b'0', b'0'),
...
--
-- Filtros para la tabla `dbconector`
--
ALTER TABLE `dbconector`
  ADD CONSTRAINT `fk_conector_categoria` FOREIGN KEY (`refcategorias`) REFERENCES `tbcategorias` (`idtcategoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_conector_countrie` FOREIGN KEY (`refcountries`) REFERENCES `dbcountries` (`idcountrie`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_conector_jugadores` FOREIGN KEY (`refjugadores`) REFERENCES `dbjugadores` (`idjugador`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_conector_refequipos` FOREIGN KEY (`refequipos`) REFERENCES `dbequipos` (`idequipo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_conector_tj` FOREIGN KEY (`reftipojugadores`) REFERENCES `tbtipojugadores` (`idtipojugador`) ON DELETE NO ACTION ON UPDATE NO ACTION;
